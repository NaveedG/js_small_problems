/* A featured number (something unique to this exercise) is an odd number that is a multiple of 7, with all of its digits occuring exactly once each. 
...
featured = num => {
  if (num >= 9876543201) 
    ...
    for (let i = 0; i <= 9876543201; i += 7) {
      if ((i > num) && (i % 2 != 0) && findDuplicate(String(i))) return i
    }
}

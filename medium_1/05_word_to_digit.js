...
wordToDigit = str => {
  ...
  return str.replace(/\b\w+\b/g, word => { // bracket punctuation from sentence using regex
    return Object.keys(obj).includes(word) ? obj[word] : word // convert each number word to its corresponding value
  })
}
